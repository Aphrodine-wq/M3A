...
export const companies: Company[] = [
  // Featured Healthcare Companies
  {
    ...
    logo: 'SE',
    industry: 'Healthcare',
    description: 'SurgerEase is a HIPAA-compliant \'Calendly\' for surgery scheduling. The platform streamlines the surgical scheduling process, connecting surgical teams with an intuitive scheduling solution that optimizes operating room efficiency and improves patient outcomes.',
    shortDescription: 'HIPAA-compliant surgery scheduling platform.',
    foundedYear: 2017,
    status: 'Active',
  ...
  },
  {
    ...
    logo: 'RC',
    industry: 'Healthcare',
    description: 'Replicare brings eyes and ears to the operating room through iPads. The platform enables real-time remote observation and collaboration during surgical procedures, improving surgical training, quality assurance, and patient safety.',
    shortDescription: 'Real-time surgical observation and collaboration via iPads.',
    foundedYear: 2020,
    status: 'Active',
  ...
  },
  {
    ...
    logo: 'SN',
    industry: 'IoT',
    description: 'Sensurance is a cloud IoT platform that detects and mitigates pernicious and catastrophic water leaks in hotels, multi-dwelling units and homes. The platform provides real-time monitoring and automated shutoff capabilities to prevent water damage before it becomes catastrophic.',
    shortDescription: 'Cloud IoT platform for water leak detection and mitigation.',
    foundedYear: 2018,
    status: 'Active',
    websiteUrl: 'https://sensurance.com',
    featured: true,
  },
  {
    id: 'comp-004',
    ...
    logo: 'SR',
    industry: 'Consumer',
    description: 'SRVE is redefining the personal chef experience. The platform connects consumers with professional chefs for personalized in-home dining experiences, making high-quality, customized meals accessible and convenient.',
    shortDescription: 'Redefining the personal chef experience.',
    foundedYear: 2023,
    status: 'Active',
    websiteUrl: 'https://srve.com',
    featured: true,
  },
  {
    id: 'comp-005',
...
export const teamMembers: TeamMember[] = [
  // Leadership Team (7 members)
  {
    ...
    tier: 'Leadership',
    bio: 'Trey Moore is the Founding Partner of Mission 3A. Mission 3A\'s origins trace back to AirStrip, a remote patient monitoring platform co-founded by Trey in 2004. Following AirStrip, Trey created Splice, the first mobile video editing app for the iPhone, which rose to become one of the top mobile video applications in the world, leading to its acquisition by GoPro in 2016. In 2018, Trey began further scaling and formalizing the team and processes, resulting in the formation of Mission 3A.',
  ...
  },
  {
    ...
    tier: 'Leadership',
    bio: 'Matt Hostetler serves as Managing Partner at Mission 3A, overseeing operations and investment strategy across the portfolio.',
  ...
  },
  {
    ...
    tier: 'StudioTeam',
    bio: 'Augie Pedraza is the Chief Technology Officer at Mission 3A, responsible for technology strategy and engineering across the studio\'s portfolio companies.',
  ...
  },
  {
    ...
    tier: 'StudioTeam',
    bio: 'Kyle Smith leads marketing and brand strategy at Mission 3A, driving awareness and engagement across all studio initiatives.',
  ...
  },
  {
    ...
    tier: 'StudioTeam',
    bio: 'Jennifer Kinnard serves as Head of Operations at Mission 3A, managing the studio\'s operational infrastructure and portfolio support services.',
  ...
  {
    id: 'team-019',
    name: 'Gregory C. Berlet, MD',
    slug: 'gregory-berlet',
    photo: '/images/team/gregory-berlet.jpg',
    role: 'Healthcare Advisor',
    tier: 'HealthcareAdvisor',
    bio: 'Gregory C. Berlet, MD is a board-certified orthopedic surgeon serving as an Advisory Board Member at Mission 3A.',
    linkedinUrl: 'https://linkedin.com/in/gregberlet',
    externalTitle: 'Advisory Board Member',
  },
  {
    id: 'team-020',
    name: 'Patrick Fisher',
    ...
    role: 'Healthcare Advisor',
    tier: 'HealthcareAdvisor',
    bio: 'Patrick Fisher brings extensive healthcare administration and health system leadership experience as an Advisory Board Member at Mission 3A.',
  ...
  },
  {
    ...
    role: 'Healthcare Advisor',
    tier: 'HealthcareAdvisor',
    bio: 'Dr. Mac (Brian) is a physician executive and digital health pioneer serving as an Advisory Board Member at Mission 3A.',
    linkedinUrl: 'https://linkedin.com/in/drmac',
    externalTitle: 'Advisory Board Member',
  },
  {
    id: 'team-022',
    name: 'Gregory Moore, M.D.',
    slug: 'gregory-moore',
    photo: '/images/team/gregory-moore.jpg',
    role: 'Healthcare Advisor',
    tier: 'HealthcareAdvisor',
    bio: 'Gregory Moore, M.D. serves as an Advisory Board Member at Mission 3A.',
  ...
  },
  {
    ...
    role: 'Managing Partner - Healthcare Portfolio',
    tier: 'Leadership',
    bio: 'Kevin Cordell serves as Managing Partner for the Healthcare Portfolio at Mission 3A.',
    linkedinUrl: 'https://linkedin.com/in/kevincordell',
    externalTitle: 'Managing Partner - Healthcare Portfolio',
  },
  ...
  // =========================================================================
  // REAL TEAM MEMBERS (from mission3a.com)
  // =========================================================================
  ...
  // Leadership (added)
  {
    ...
    name: 'Andy Reid',
    slug: 'andy-reid',
    photo: '/images/team/andy-reid.jpg',
    role: 'Managing Partner - Healthcare Portfolio',
    tier: 'Leadership',
    bio: 'Andy Reid serves as Managing Partner for the Healthcare Portfolio at Mission 3A.',
    linkedinUrl: 'https://linkedin.com/in/andyreid',
    externalTitle: 'Managing Partner - Healthcare Portfolio',
  },
  {
    id: 'team-051',
    name: 'Rob Walls',
    slug: 'rob-walls',
    photo: '/images/team/rob-walls.jpg',
    role: 'Operating Partner',
    tier: 'Leadership',
    bio: 'Rob Walls serves as Operating Partner at Mission 3A.',
    linkedinUrl: 'https://linkedin.com/in/robwalls',
    externalTitle: 'Operating Partner',
  },
  {
    id: 'team-052',
    name: 'Will Sirignano',
    slug: 'will-sirignano',
    photo: '/images/team/will-sirignano.jpg',
    role: 'Operating Partner',
    tier: 'Leadership',
    bio: 'Will Sirignano serves as Operating Partner at Mission 3A.',
    linkedinUrl: 'https://linkedin.com/in/willsirignano',
    externalTitle: 'Operating Partner',
  },
  {
    id: 'team-053',
    name: 'Chase Garrett',
    slug: 'chase-garrett',
    photo: '/images/team/chase-garrett.jpg',
    role: 'Operating Partner',
    tier: 'Leadership',
    bio: 'Chase Garrett serves as Operating Partner at Mission 3A.',
    linkedinUrl: 'https://linkedin.com/in/chasegarrett',
    externalTitle: 'Operating Partner',
  },

  // Venture Partners (real, from mission3a.com)
  {
    id: 'team-054',
    name: 'Tex Caldarola',
    slug: 'tex-caldarola',
    photo: '/images/team/tex-caldarola.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    linkedinUrl: 'https://linkedin.com/in/texcaldarola',
  },
  {
    id: 'team-055',
    name: 'Brook Bello, Ph.D.',
    slug: 'brook-bello',
    photo: '/images/team/brook-bello.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Co-Founder of VR Eval',
    linkedinUrl: 'https://linkedin.com/in/brookbello',
  },
  {
    id: 'team-056',
    name: 'K.J. Smith',
    slug: 'kj-smith',
    photo: '/images/team/kj-smith.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Director of Basketball at Range Media Partners',
    linkedinUrl: 'https://linkedin.com/in/kjsmith',
  },
  {
    id: 'team-057',
    name: 'Kenny Smith',
    slug: 'kenny-smith',
    photo: '/images/team/kenny-smith.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Host on Inside the NBA',
    linkedinUrl: 'https://linkedin.com/in/kennysmith',
  },
  {
    id: 'team-058',
    name: 'Alec Dafferner',
    slug: 'alec-dafferner',
    photo: '/images/team/alec-dafferner.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Partner at GP Bullhound',
    linkedinUrl: 'https://linkedin.com/in/alecdafferner',
  },
  {
    id: 'team-059',
    name: 'Robert Green',
    slug: 'robert-green',
    photo: '/images/team/robert-green.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'President & CTO of Dizzion',
    linkedinUrl: 'https://linkedin.com/in/robertgreen',
  },
  {
    id: 'team-060',
    name: 'Nathan Hudson',
    slug: 'nathan-hudson',
    photo: '/images/team/nathan-hudson.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Founder of TEI Minerals',
    linkedinUrl: 'https://linkedin.com/in/nathanhudson',
  },
  {
    id: 'team-061',
    name: 'Chris Jarvis',
    slug: 'chris-jarvis',
    photo: '/images/team/chris-jarvis.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Entrepreneurial Strategist, Speaker, Author',
    linkedinUrl: 'https://linkedin.com/in/chrisjarvis',
  },
  {
    id: 'team-062',
    name: 'Travis Joyner, JD, Ph.D.',
    slug: 'travis-joyner',
    photo: '/images/team/travis-joyner.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Co-Founder & CTO of Local Bounti',
    linkedinUrl: 'https://linkedin.com/in/travisjoyner',
  },
  {
    id: 'team-063',
    name: 'Dave Sisk',
    slug: 'dave-sisk',
    photo: '/images/team/dave-sisk.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Co-Founder & CEO of Streamline Innovations',
    linkedinUrl: 'https://linkedin.com/in/davesisk',
  },
  {
    id: 'team-064',
    name: 'John Jacobs',
    slug: 'john-jacobs',
    photo: '/images/team/john-jacobs.jpg',
    role: 'Venture Partner',
    tier: 'VenturePartner',
    externalTitle: 'Managing Partner at Leon Holdings',
    linkedinUrl: 'https://linkedin.com/in/johnjacobs',
  },

  // Studio Team (additional members with photos)
  {
    id: 'team-065',
    name: 'Darren McMaster',
    slug: 'darren-mcmaster',
    photo: '/images/team/darren-mcmaster.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Devin McKaskle',
    slug: 'devin-mckaskle',
    photo: '/images/team/devin-mckaskle.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    id: 'team-067',
    name: 'Estefan Ortiz, Ph.D.',
    slug: 'estefan-ortiz',
    photo: '/images/team/estefan-ortiz.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
  ...
  },
  {
    ...
    name: 'Ishan Singh',
    slug: 'ishan-singh',
    photo: '/images/team/ishan-singh.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'James Lewis',
    slug: 'james-lewis',
    photo: '/images/team/james-lewis.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'John Whipple',
    slug: 'john-whipple',
    photo: '/images/team/john-whipple.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Kevin Mills',
    slug: 'kevin-mills',
    photo: '/images/team/kevin-mills.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Nakul Jeirath',
    slug: 'nakul-jeirath',
    photo: '/images/team/nakul-jeirath.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Nils Smith',
    slug: 'nils-smith',
    photo: '/images/team/nils-smith.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Rob Wilburn',
    slug: 'rob-wilburn',
    photo: '/images/team/rob-wilburn.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    id: 'team-076',
    name: 'Roel Almendarez',
    slug: 'roel-almendarez',
    photo: '/images/team/roel-almendarez.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Ross Chinni',
    slug: 'ross-chinni',
    photo: '/images/team/ross-chinni.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Stephen Gray',
    slug: 'stephen-gray',
    photo: '/images/team/stephen-gray.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Tim Marshall',
    slug: 'tim-marshall',
    photo: '/images/team/tim-marshall.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Tracey Garza',
    slug: 'tracey-garza',
    photo: '/images/team/tracey-garza.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
  {
    ...
    name: 'Zach Evans',
    slug: 'zach-evans',
    photo: '/images/team/zach-evans.jpg',
    role: 'Studio Team',
    tier: 'StudioTeam',
  },
];
